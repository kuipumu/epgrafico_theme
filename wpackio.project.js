...
module.exports = {
	// Project Identity
	appName: 'epgrafico', // Unique name of your project
	type: 'theme', // Plugin or theme
	slug: 'epgrafico', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
		...
		// If this has length === 1, then single compiler
		{
	        ...
	        // The values can be string or Array of strings (string|string[])
		      ...
		      // global namespace pollutions 😉
		 		...
		 		main: ['./src/desktop/js/index.js'], // Or an array of string (string[])
		 	},
